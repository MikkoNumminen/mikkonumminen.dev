...
Mikään ei ilmoittanut tästä. Se näkyy vain yhdessä paikassa, kunkin agentin omassa metadatassa, jossa tyyppi lukee workflow-subagent agentin nimen sijaan. Viisi review-workflow'ta oli mennyt sillä tavalla. Yhteensä ne kuluttivat suunnilleen 3,8 miljoonaa tokenia orkestraattorin hinnoilla, eivätkä arvostelut olleet siitä viisi kertaa parempia.

Korjaus oli kolme asiaa. Aukko on nyt kirjattu README:en, koska seuraava, joka kompastuu siihen, olen minä. Kaksi uutta agenttia, reviewer ja refuter, antavat review-fan-outille jotain halpaa, johon osoittaa: yksi katsaus diffiin Sonnetilla, yksi adversariaalinen läpikäynti per löydös Haikulla. Ja opt-in-hook lukee workflow-skriptin ennen kuin se ajetaan ja nimeää kutsut, jotka eivät kiinnitä mitään.
...
Se oli myös kahdesti väärässä ennen kuin se oli oikeassa, tavoilla, joita omat testini eivät olleet osanneet kysyä. Se löytää kutsut skannaamalla tekstiä, joten kiinnittämätön kutsu, jonka promptissa sattui olemaan sanat model:, luettiin kiinnitetyksi, ja sisäkkäinen kutsu antoi sisemmän kiinnityksen todistaa ulomman puolesta. Molemmat johtuivat siitä, että koko kutsua kohdeltiin koodina. Nyt se tyhjentää ensin merkkijonot, template literalit ja kommentit, ja laskee sulkeet siitä, mitä jää jäljelle.
...
Agentit, hook ja tikapuut, jotka päättävät, mikä reititetään minne, ovat julkisia osoitteessa [github.com/MikkoNumminen/claude-agents](https://github.com/MikkoNumminen/claude-agents).

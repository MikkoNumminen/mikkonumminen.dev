...
export const fi: Translations = {
  ...
  timelineData: {
    ...
    '2026-build': {
      ...
      body: 'Seitsemän tuotantoon vietyä projektia. HRM — portfolio-tasoinen HR-järjestelmä (yli 1828 testiä 91,9 % kattavuudella, kaksi tietokantaa, TOTP-2FA, hajautusketjutettu auditloki) — syöttää Platformia, tuotantokäytössä olevaa yhteisöalustaa osoitteessa vuohiliitto.com, joka rakentuu HRM:n päälle alimoduulina: pelillistäminen, reaaliaikainen chatti, Mythic+ -tiimiseuranta Raider.IO-rajapinnalla. Spacepotatis on Phaser 3 + Three.js -kosmos osoitteessa spacepotatis.vercel.app. AudiobookMaker on Windows-työpöytäsovellus (1884 testiä), joka muuntaa PDF-, EPUB- ja tekstitiedostoja MP3-äänikirjoiksi kolmen TTS-moottorin avulla: Edge-TTS pilvestä, Piper paikallisesti ilman verkkoa, ja Chatterbox neuraaliseen suomenkieliseen kerrontaan LoRA-ääniklonauksella; allekirjoitettu asennusohjelma automaattipäivityksillä, testattu päästä päähän oikealla 10-tuntisella äänikirjalla. ReadLog seuraa lukemista Open Library- ja Google Books -rajapintojen päällä. strudel-patterns tutkii live-koodattua musiikkia. Tämä Portfolio-sivusto (Astro + Three.js + GSAP) sitoo kaiken yhteen.',
      tags: [
        '7 repoa',
        'Oikeita käyttäjiä',
        'Next.js',

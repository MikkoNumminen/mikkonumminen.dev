...
- **Total measurement cost (mikko- suite):** ~2.54M `subagent_tokens` across its 48 arms (8 skills × 2 × 3; Opus ~931K, Sonnet ~856K, Haiku ~751K). The Spacepotatis and AudiobookMaker corpora add **24 arms each** (4 × 2 × 3) — **96 arms** across all three.

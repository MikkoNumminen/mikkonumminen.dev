...
- `AUDIT.md` / `AUDIT-2026-05-07.md` sit at the repo root rather than in [`docs/audits/`](.) — less discoverable.
...
- Git worktree workflow adopted — multiple branches coexist without checkout thrash.
...
| # | Action | Status |
| --- | --- | --- |
| 1 | Add `CLAUDE.md` | **Done** (this PR) |
| 2 | Add `.claude/settings.json` allowlist | Pending |

...
- **HRM** — production HR system. Next.js, React, TypeScript, PostgreSQL + MongoDB (dual-database: relational + immutable audit log), 34 permissions, TOTP 2FA, OpenTelemetry, 18 languages, SSE notifications. 1828+ tests, 91.9% coverage, Stryker mutation testing. [hr-manager-pearl.vercel.app](https://hr-manager-pearl.vercel.app)
...
- **Spacepotatis** — live browser game. Next.js 15 + Phaser 3 + Three.js. Empty repo to live in 12 days, 387 commits, ~1170 tests. PostgreSQL via Kysely, Google OAuth, cloud saves, leaderboard. [spacepotatis.vercel.app](https://spacepotatis.vercel.app)
- **AudiobookMaker** — Windows desktop app. PDF/EPUB/text → audiobook via four TTS engines (Edge-TTS cloud, Piper offline, Chatterbox voice cloning, VoxCPM2). 16-pass Finnish text normalization. 2400+ tests. Ships via GitHub Releases with auto-updates.
...
TypeScript, React, Next.js, PostgreSQL, Prisma, Python, Astro, Three.js, GSAP, Turborepo, Jest, Playwright, Phaser 3, Kysely, NextAuth, MUI, Tailwind CSS, Docker, GitHub Actions

...
Type `download` in the terminal. It offers the CV and a `--research` menu. Type
`download --research` to list the research documents, or grab any of them
directly with its own flag.
